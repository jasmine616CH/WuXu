...
@Slf4j
public class scrapDataListener implements ReadListener<repairData> {
    ...
    public scrapDataListener(scrapService scrapService){
    ...
    private void saveData() {
        scrapService.scrapRead(repairDataList);
    }
