...
@Slf4j
public class repairDataListener implements ReadListener<repairData> {
    ...
    public repairDataListener(repairService repairService){
    ...
    private void saveData() {
        repairService.repairRead(repairDataList);
    }
